...
export function CheckoutModal({
  ...
  const total = parseFloat(
    (subtotal - discountAmt + tax + serviceCharge).toFixed(2),
  );
  ...
  return (
    ...
    >
      <KeyboardAvoidingView
        ...
        style={{ flex: 1 }}
      >
        {/* ── Backdrop — tap to dismiss keyboard only, NOT to close modal ── */}
        <Pressable
        ...
        {/* ── Bottom sheet — fixed max height so ScrollView can actually scroll ── */}
        <View
          style={{
        ...
        >
          ...
          {/* ── Scrollable content — this now has a bounded parent so it scrolls ── */}
          <ScrollView
                ...
                {tendered > 0 && (
                  ...
                  >
                    ...
                    >
                      ...
                      {change < 0 ? ` (short by ${fmt(Math.abs(change))})` : ""}
                    </Text>
                  </View>
                )}
              </View>
